...
class _BookingScreenState extends State<BookingScreen> {
  ...
  // Function to check availability of the parking spot
  Future<void> _checkAvailability() async {
    if (_startTime != null && _endTime != null) {
      final url = 'http://10.0.2.2:5000/check_availability'; // Replace with your backend API URL
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['conflict']) {
          ...
          // Navigate to SSLCommerzScreen if no conflict
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => SSLCommerzScreen(
  ...
  // Function to display conflicting bookings
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: _startTime != null && _endTime != null
                  ? _checkAvailability // Check availability before proceeding to payment
                  : null,
              child: Text('Confirm Booking & Pay'),
            ),
          ],
